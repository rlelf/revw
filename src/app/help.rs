pub fn get_help_content() -> Vec<String> {
    vec![
        ...
        "  revw --stdout --inside file.json   - output INSIDE section only".to_string(),
        ...
        "".to_string(),
        "  # Delete matching entries (writes in-place)".to_string(),
        "  revw --delete --filter pattern file.json".to_string(),
        "  revw --delete --filter pattern --inside file.json".to_string(),
        "".to_string(),
        "═══════════════════════════════════════════════════════════════".to_string(),
        "".to_string(),
