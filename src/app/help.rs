pub fn get_help_content() -> Vec<String> {
    vec![
        ...
        "  revw --json file.json       - Open in Edit mode".to_string(),
        ...
        "  :set extension              - show file extensions in explorer".to_string(),
        "  :set noextension            - hide file extensions in explorer".to_string(),
        "".to_string(),
